...
public class ChatActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        newDialog.setNegativeButton(R.string.CANC, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (idItem) {
            ...
            case R.id.vaciar:
                ...
                alertDialogBuilder.setNegativeButton(R.string.CANC, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
                    }
